  ...
  return <View style={styles.container}>
      <View style={styles.header}>
        <View style={styles.headerImage}>
          ...
          {user2.isOnline && <Image source={require('./assets/online.png')} style={styles.activityIconHeader} /> || null}
        </View>
      ...
      <ScrollView style={styles.body}>
        {conversation.map((message, index) => <ConversationElement message={message} />)}
      </ScrollView>
      <View style={styles.footer}>
        ...
        <View style={styles.inputContainer}>
          ...
          <Image source={require('./assets/smiley.png')} style={styles.smileyIcon} />
...
const ConversationElement = ({
  ...
  return <View style={[styles.messageContainer, boxAlignment]}>
      <View style={styles.profileImageContainer}>
        <Image source={message.sender.image} style={styles.profileImage} />
        {message.sender.isOnline && <Image source={require('./assets/online.png')} style={styles.activityIcon} /> || null}
      </View>

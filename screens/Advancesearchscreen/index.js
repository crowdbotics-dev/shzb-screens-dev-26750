...
const AdvanceSearchScreen = params => {
  ...
  const [ratingImages, setRatingImages] = useState([require('./assets/1star.png'), require('./assets/2star.png'), require('./assets/3star.png'), require('./assets/4star.png'), require('./assets/5star.png')]);
...
const Filter = ({
  ...
  return <View style={[styles.filter, filterStyle]}>
